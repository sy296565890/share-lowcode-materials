import AntdProFormConditionMeta from '/home/lc/lc/share-lowcode-materials/lowcode/antd-pro-form-condition/meta'
import ColorfulButtonMeta from '/home/lc/lc/share-lowcode-materials/lowcode/colorful-button/meta'
import ColorfulInputMeta from '/home/lc/lc/share-lowcode-materials/lowcode/colorful-input/meta'
...
function fillRealVersion(meta, packageName = 'share-lowcode-materials', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
const componentMetas = [AntdProFormConditionMeta,ColorfulButtonMeta,ColorfulInputMeta];
const components = [];
const npmInfo = {"package":"share-lowcode-materials","version":"0.1.0"};
...
if (!execCompile) {
  window.ShareLowcodeMaterialsMeta = { components, componentList };
}